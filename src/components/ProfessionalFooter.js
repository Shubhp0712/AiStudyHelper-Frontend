    ...
    const socialLinks = [
        {
            ...
            href: 'https://github.com/Shubhp0712'
        },
        {
            name: 'Gmail',
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 2v.01L12 13 4 6.01V6h16zm0 2.24l-8 6.76-8-6.76V18h16V8.24z" />
                </svg>
            ),
        ...
        },
        {
            ...
            href: 'https://www.linkedin.com/in/shubh-patel-7456bb283?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app'
        }
    ];
